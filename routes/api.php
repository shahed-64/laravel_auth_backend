...
Route::get(
    ...
    [TeachersAttendanceController::class, 'teacherSummaryReport']
);

Route::get(
    '/teachers/{id}/yearly-report',
    [TeachersAttendanceController::class, 'singleTeacherYearlyReport']
);
...
Route::apiResource(
    'teacher-attendances',
    TeachersAttendanceController::class
);

Route::get(
    '/teacher-attendances/report/{teacherId}',
    [TeachersAttendanceController::class, 'report']
);
...
Route::get(
    ...
    [ClassGroupController::class, 'subjects']
);

Route::apiResource(
    'institute-info',
    InstituteInfoController::class
);
...
|
| IMPORTANT:
| Custom student final-result route must come BEFORE
| apiResource('final-results', ...)
|
*/
